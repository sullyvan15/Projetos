...
const Home = () => (
  <View style={gStyle.container}>
    ...
    <ScrollView scrollEventThrottle={16} showsVerticalScrollIndicator={false}>
      ...
      <Text style={gStyle.heading}>Originais</Text>
      <MediaItemScroller dataset="originals" />

      <Text style={gStyle.heading}>Recomendado para você</Text>
      <MediaItemScroller dataset="recommended" />

      <Text style={gStyle.heading}>Filmes em alta</Text>
      <MediaItemScroller dataset="hits" />

      <Text style={gStyle.heading}>Em alta</Text>
      <MediaItemScroller dataset="trending" />

      <Text style={gStyle.heading}>Out of the Vault</Text>
      <MediaItemScroller dataset="vault" />

      <Text style={gStyle.heading}>Ultra HD e HDR</Text>
